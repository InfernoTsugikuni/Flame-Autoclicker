...
Section -AdditionalIcons
  ...
  ${Else}
    ...
    CreateShortCut "$STARTMENU\Programs\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" "$INSTDIR\FlameAutoclicker.exe"
...
Section -Post
  ...
  ${If} $IsAdminInstall == "true"
    ...
    WriteRegStr HKLM "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\FlameAutoclicker.exe"
  ...
  ${Else}
    ...
    WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\App Paths\FlameAutoclicker.exe" "" "$INSTDIR\FlameAutoclicker.exe"
    ...
    WriteRegStr HKCU "${PRODUCT_USER_UNINST_KEY}" "DisplayIcon" "$INSTDIR\FlameAutoclicker.exe"
...
Section Uninstall
  ...
  ${Else}
    ...
    DeleteRegKey HKCU "Software\Microsoft\Windows\CurrentVersion\App Paths\FlameAutoclicker.exe"
  ${EndIf}
